<?php
include "../actividades/Arimetica.php";
$aritmetica = new Arimetica();
...
if($operando !== null && $operador !== null && $operacion !== null){
    ...
    switch($operacion){
        case "+":
            $resultado = $aritmetica->sumar($operando, $operador);
            break;
        case "-":
            $resultado = $aritmetica->restar($operando, $operador);
            break;
        case "/":
            $resultado = $aritmetica->dividir($operando, $operador);
            break;
        case "*":
            $resultado = $aritmetica->multiplicar($operando, $operador);
            break;
    }
}
?>
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <form action="arimetica2.php" method="GET">
